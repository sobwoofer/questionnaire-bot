...
(function($){
  	...
  	================================================================*/
		if($('.minimalio-services-menus ul li a').exists()){
		    $(document).on('click', '.minimalio-services-menus ul li a', function(e){
		    	...
		    	$('.minimalio-equal-grid, .minimalio-grid').isotope({
		          filter: filterData
		        });
		    });
		}
  ...
  ================================================================*/
	...
	if($('#minimalio-hero-slide').exists()){
...
$(".minimalio-equal-grid .minimalio-img-container > img").each(function(i, img) {
    $(img).css({
        position: "relative",
